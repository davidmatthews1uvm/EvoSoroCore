...
VXC_Wrapper().write_to_xml(root, [Material(1, name="Test1"), Material(2, name="Test2")], None)



print(etree.tostring(root, pretty_print=True, xml_declaration=True, encoding="ISO-8859-1").decode("utf-8"))
